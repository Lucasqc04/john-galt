export function Sobre() {
  return (
    <div>
      ...
      <div>
        <p>
          Somos uma família deconstruindo um ecossistema P2P, sem KYC, para ser
          usado por qualquer um, em qualquer lugar.
        </p>
        <br />
        <p>
          De acordo com a praxeologia, a lógica da ação humana sempre busca a
          mudança de um estado menos satisfatório para outro mais satisfatório.
          A Diy Sec Lab permite o livre mercado de vendedores e compradores P2P,
          da forma mais simples e amigável.
        </p>
        <br />
        <p>
          Ao contrário de uma exchange convencional de criptomoedas, nós
          conectamos compradores e vendedores no formato P2P, de forma segura e
          privada. Todos os Bitcoins negociados na Diy Sec Lab são whitelisted,
          ou seja, não vieram através de atividades ilícitas e são totalmente
          legais.
        </p>
        <b />
        <p>
        ...
        <p>
          ...
          analisado cuidadosamente até a sua resolução. Estamos comprometidos em
